...
interface IntroProps {
  close: () => void; // replace with the actual type of `close`
}
    ...
    <Primitives.Wizard>
      <IntroMain>
        ...
        <Primitives.Paragraphs.Lead>
          Skal du bygge noe? Stort eller smått? Husk at du må holde deg innenfor
          det som kalles <strong>tillatt grad av utnytting</strong>. Det
          bestemmer hvor stor del av eiendommen du har lov å bygge på. Bruk
          denne veilederen for å være sikker på at du ikke bygger for stort.
        </Primitives.Paragraphs.Lead>
        <section>
          <div>
            ...
            <ol>
              <li>
                Reguleringsplan for eiendommen din (hvis kommunens nettside har
                en kartløsning, er som regel reguleringsplanen der)
              </li>
              ...
              <li>
                ...
                <a href='http://www.seeiendom.no/'>
                  se eiendommens størrelse på seeiendom.no
                </a>
              </li>
            </ol>
          </div>
        ...
        <section>
          <div>
            ...
            <ol>
              <li>
                Om eiendommen din er regulert (finnes det en reguleringsplan er
                eiendommen regulert)
              </li>
              <li>
                Om det står noe om tillatt grad av utnytting i reguleringsplan
                eller kommuneplan.{' '}
                <span style={{ color: '#c1272d', fontWeight: 'bold' }}>
                  Merk!
                </span>{' '}
                Dette må stå oppgitt som en av følgende:
                <ul>
                  <li>BYA eller %BYA</li>
                  <li>BRA eller %BRA</li>
                  <li>%TU</li>
              ...
              <li>
                Om det står noe i kommuneplanen/-delplanen om at den gjelder
                foran reguleringsplanen
              </li>
              <li>
                ...
                Sjekk nøye at du har siste versjon av planene
              </li>
              <li>Om kommunen har en parkeringsnorm</li>
              <li>
                Hvor mange parkeringsplasser det er krav til at du har i
                terrenget (ikke i garasje) på eiendommen din, og hvor stor hver
                plass må være
              </li>
            </ol>
          </div>
